...
function ReservaCard({ reserva }) {
    ...
    async function CompletarReserva(e) {
        e.preventDefault();
        const response = await fetch(
            'https://localhost:7071/api/Reversaciones/CompletarReserva/' + reserva.id,
        );
    ...
    return (
        <li className="list-group-item">
            <div>
                ...
                <img className='btnCard' onClick={CompletarReserva} src="imagen/cheque.png" alt="cheque" />
